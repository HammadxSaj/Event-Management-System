  ...
  const handleResponse = async (isAvailable) => {
    try {
      ...
      const responsesHtml = Object.entries(rsvpResponses)
        .map(
          ([question, answer]) =>
            `<p style="margin: 0 0 10px;"><strong>${question}:</strong> ${answer}</p>`
        )
        .join("");
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
      <h2 style="color: #1E90FF;">Thank You for Your RSVP! 🎉</h2>
      <p><strong>You have responded with ${
        isAvailable ? "Yes" : "No"
      } to the RSVP form for the event <em>${idea.title}</em>.</strong></p>
      <h3 style="color: #1E90FF;">Your Responses:</h3>
      ${responsesHtml}
      <p>We appreciate your response and look forward to ${
        isAvailable
          ? "seeing you at the event"
          : "your participation in future events"
      }.</p>
      <p>If you have any questions or need to update your response, please feel free to contact us.</p>
      <p>Best regards,<br>
      <strong>The Eventiti Team</strong></p>
      <hr style="border: none; border-top: 1px solid #ddd; margin: 20px 0;">
      <p style="font-size: 0.9em; color: #888;">
        You received this email because you RSVP'd to an event on Eventiti. If you no longer wish to receive these emails, please <a href="https://unsubscribe-link.com" style="color: #1E90FF;">unsubscribe here</a>.
      </p>
    </div>
  `,
      });
        ...
        <Container className="rsvp-container rsvp-page">
          ...
          <div className="header-container">
            ...
            <h3 className="header-slogan">
              Don't Miss Out - Register Now for an Unforgettable Experience!
            </h3>
          </div>
            ...
            <Card className="p-4 shadow-lg rsvp-form-card">
              {userProfile && userProfile.photoURL && (
                <div className="profile-picture-container text-center mb-4">
                  ...
                  <div className="rsvp-idea-deets">
                    ...
                    >
                      <FaCalendarAlt
                        style={{ marginRight: "8px", color: "#D96758" }}
                      />
                      <Typography variant="body2" color="text.secondary">
                        <h2 className="rsvp-idea">
                          {new Date(idea.dateTime).toLocaleDateString()}
                        </h2>
                      </Typography>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <Typography variant="body2" color="text.secondary">
                        <h2 className="rsvp-idea">
                          {new Date(idea.dateTime).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </h2>
              ...
              <div className="rsvp-question">
                <Typography variant="h6" component="div" gutterBottom>
                  <h3 className="rsvp-mandatory-question">
                ...
                {response && (
                  <div paragraph className="response">
